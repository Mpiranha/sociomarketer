...
$(function () {
  ...
  function pauseAllAudio() {
    allAudioEls.each(function () {
      ...
      $(this)
        .siblings()
        .find(".play-img")
        .attr("src", "../assets/icons/play_cr.svg");
    });
  }
  ...
  $(".btn-play-pause-campaign").on("click", function () {
    if ($(this).attr("state") == "playing") {
      $(this).attr("data-original-title", "Play Campaign");
      $(this).attr("title", "Play Campaign");
      $(this).attr("state", "pause");
      $(this).children("img").attr("src", "../assets/icons/play.png");
    } else {
      $(this).attr("data-original-title", "Pause Campaign");
      $(this).attr("title", "Pause Campaign");
